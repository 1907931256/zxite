...
Public Const SCI_SETSELBACK = SCI_START + 68
...
Public Const SCI_SETSTYLEBITS = 2090        ' Determinar el número de bits adicionales de estilo que se usarán
...
Public Const SCFIND_WHOLEWORD = 2           ' Modificadores de búsqueda. Palabra completa.
Public Const SCFIND_MATCHCASE = 4           ' Modificadores de búsqueda. Coincidir mays/min.
Public Const SCFIND_WORDSTART = &H100000    ' Modificadores de búsqueda. Comienzo de palabra.
Public Const SCFIND_REGEXP = &H200000       ' Modificadores de búsqueda. Expresión regular.
...
Public Const SQLEND = """]"                                    ' Final para la cadena XPath
