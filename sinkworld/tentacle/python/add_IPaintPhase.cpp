...
void add_IPaintPhase() {
    class_< IPaintPhase, boost::noncopyable, IPaintPhase_Wrapper >("IPaintPhase", no_init)
        .def("FlagsUse", pure_virtual(&IPaintPhase::FlagsUse))
        .def("Paint", pure_virtual(&IPaintPhase::Paint))
    ;
