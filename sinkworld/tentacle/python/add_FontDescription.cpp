...
void add_FontDescription() {
    class_< FontDescription >("FontDescription", init<  >())
        .def(init< const Literal*, int, bool, bool >())
        .def(init< const FontDescription& >())
        .def_readonly("font", &FontDescription::font)
        .def_readwrite("height", &FontDescription::height)
        .def_readwrite("bold", &FontDescription::bold)
        .def_readwrite("italics", &FontDescription::italics)
        .def("Hash", &FontDescription::Hash)
        .def("Equals", &FontDescription::Equals)
    ;
