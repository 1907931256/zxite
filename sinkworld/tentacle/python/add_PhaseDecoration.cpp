...
void add_PhaseDecoration() {
    class_< PhaseDecoration, bases< IPaintPhase > , boost::noncopyable, PhaseDecoration_Wrapper >("PhaseDecoration", init< bool >())
        .def("FlagsUse", (int (PhaseDecoration::*)() )&PhaseDecoration::FlagsUse, (int (PhaseDecoration_Wrapper::*)())&PhaseDecoration_Wrapper::default_FlagsUse)
        .def("Paint", (void (PhaseDecoration::*)(PaintParameters*) )&PhaseDecoration::Paint, (void (PhaseDecoration_Wrapper::*)(PaintParameters*))&PhaseDecoration_Wrapper::default_Paint)
    ;
