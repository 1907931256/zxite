...
void add_ChangePositionsCache() {
    class_< ChangePositionsCache, boost::noncopyable >("ChangePositionsCache", init<  >())
        .def("Clear", &ChangePositionsCache::Clear)
        .def("Find", &ChangePositionsCache::Find, return_internal_reference<>())
        .def("Set", &ChangePositionsCache::Set)
    ;
