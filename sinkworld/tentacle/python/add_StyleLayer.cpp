...
void add_StyleLayer() {
    class_< StyleLayer, bases< ChangeLayer > , boost::noncopyable, StyleLayer_Wrapper >("StyleLayer", init< int, int, IStyles*, int >())
        .def_readwrite("pstyles", &StyleLayer::pstyles)
        .def("FindNextChange", (void (StyleLayer::*)(int) )&StyleLayer::FindNextChange, (void (StyleLayer_Wrapper::*)(int))&StyleLayer_Wrapper::default_FindNextChange)
    ;
