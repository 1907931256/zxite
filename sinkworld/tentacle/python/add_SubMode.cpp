...
void add_SubMode() {
    class_< SubMode, boost::noncopyable >("SubMode", init< Literal*, OptionSet* >())
        .def_readwrite("mode", &SubMode::mode)
        .def_readwrite("lexerName", &SubMode::lexerName)
        .def_readwrite("lexer", &SubMode::lexer)
        .def_readwrite("folderName", &SubMode::folderName)
        .def_readwrite("folder", &SubMode::folder)
    ;
