...
void add_PhaseText() {
    class_< PhaseText, bases< IPaintPhase > , boost::noncopyable, PhaseText_Wrapper >("PhaseText", no_init)
        .def("FlagsUse", (int (PhaseText::*)() )&PhaseText::FlagsUse, (int (PhaseText_Wrapper::*)())&PhaseText_Wrapper::default_FlagsUse)
        .def("Paint", (void (PhaseText::*)(PaintParameters*) )&PhaseText::Paint, (void (PhaseText_Wrapper::*)(PaintParameters*))&PhaseText_Wrapper::default_Paint)
    ;
