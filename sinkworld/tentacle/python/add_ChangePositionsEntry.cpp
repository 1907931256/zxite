...
void add_ChangePositionsEntry() {
    class_< ChangePositionsEntry, boost::noncopyable >("ChangePositionsEntry", init<  >())
        .def_readwrite("line", &ChangePositionsEntry::line)
        .def_readwrite("cf", &ChangePositionsEntry::cf)
        .def("Match", &ChangePositionsEntry::Match)
        .def("Set", &ChangePositionsEntry::Set)
    ;
