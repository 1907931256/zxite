...
void add_LinePositionCache() {
    class_< LinePositionCache, boost::noncopyable >("LinePositionCache", init<  >())
        .def("Clear", &LinePositionCache::Clear)
        .def("Find", &LinePositionCache::Find, return_internal_reference<>())
        .def("Set", &LinePositionCache::Set)
    ;
